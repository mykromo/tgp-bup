...
<div style="text-align: center; margin-top: 10px;">
    <a href="#" data-toggle="modal" data-target="#imprintModal" style="text-decoration: underline; color: #777;">
        Basahin ang paalala
    </a>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Mahalagang Paalala</h4>
            </div>
            <div class="modal-body">
                Pakitingnan ang iyong <strong>spam folder</strong> para sa invitation link matapos mag-register. 
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" data-dismiss="modal">Naintindihan ko</button>
            </div>
        </div>
    </div>
</div>
