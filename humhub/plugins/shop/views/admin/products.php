...
<div class="panel-heading">
    ...
    <div class="pull-right">
        <a href="<?= $cc->createUrl('/shop/admin/create-product') ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> <?= Yii::t('ShopModule.base', 'Add Product') ?></a>
        <a href="<?= $cc->createUrl('/shop/admin/orders') ?>" class="btn btn-default btn-sm"><i class="fa fa-list"></i> <?= Yii::t('ShopModule.base', 'Orders') ?></a>
        <a href="<?= $cc->createUrl('/shop/admin/settings') ?>" class="btn btn-default btn-sm"><i class="fa fa-cog"></i> <?= Yii::t('ShopModule.base', 'Settings') ?></a>
    </div>
</div>
...
<tr class="<?= !$p->is_active ? 'text-muted' : '' ?>">
    ...
    <td class="text-right">
        <a href="<?= $cc->createUrl('/shop/admin/edit-product', ['id' => $p->id]) ?>" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i> Edit</a>
    </td>
</tr>
<?php endforeach; ?>
</tbody></table></div>
