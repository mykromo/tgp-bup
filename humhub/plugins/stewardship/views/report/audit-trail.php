...
<td><?php if ($log->field_changed): ?><strong><?= Html::encode($log->field_changed) ?></strong>: <?php if ($log->old_value): ?><s class="text-muted"><?= Html::encode($log->old_value) ?></s> &rarr; <?php endif; ?><?= Html::encode($log->new_value) ?><?php endif; ?></td>
</tr>
<?php endforeach; ?>
</tbody></table></div>
<?php endif; ?>
